    ...
    <div class="user_options-container">
      <div class="user_options-text">
        <div class="user_options-unregistered">
          <h2 class="user_unregistered-title">Want to see your profile? </h2>
          ...
          <button type="button" onclick="window.location.href='{{ route('user.profile') }}'" class="user_unregistered-signup" id="signup-button">Go to profile</button>
        </div>
